(window.__twttrll = window.__twttrll || []).push([
	[3], {
		...
		174: function(t, e, a) {
			...
			t.exports = function() {
				...
				return e.prototype = Object.create(t.prototype), i.aug(e.prototype, {
					...
					select: function(t, e) {
						return 1 === arguments.length && (e = t, t = this.el), t ? (e = this.selectors[e] || e, i.toRealArray(t.querySelectorAll(
							e))) : []
					},
					selectOne: function() {
					...
					on: function(t, e, a) {
						var r, s = this.el;
						this.el && (t = (t || "").split(/\s+/), 2 === arguments.length ? a = e : r = e, r = this.selectors[r] || r,
							a = o(a, this), t.forEach(r ? function(t) {
								n.delegate(s, t, r, a)
							} : function(t) {
		...
		222: function(t, e, a) {
			...
			t.exports = n.couple(a(171), a(172), function(t) {
				t.params({
					screenName: {
						required: !0
					},
					...
					return this.scribeImpression(), r.all([this.sandbox.setTitle(f), this.sandbox.addClass(d), this.sandbox.loadDocument(
						a)])
				})
			})
		},
		254: function(t, e, a) {
			...
			t.exports = m.couple(a(171), a(172), function(t) {
				t.params({
					lang: {
						required: !0,
					...
					return "share" === this.params.type ? (t = t || n.title, e = e || c.getCanonicalURL() || s.href, a = a || i) :
						i && (r = r ? i + "," + r : i), l.compact({
							id: this.id,
							lang: this.params.lang,
							size: this.params.size,
					...
					return this.scribeImpression(), r.all([this.sandbox.setTitle(w), this.sandbox.addClass(v), this.sandbox.addClass(
						t), this.sandbox.loadDocument(n)])
				})
			})
		},
		87: function(t, e, a) {
